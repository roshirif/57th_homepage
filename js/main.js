...
document.addEventListener('DOMContentLoaded', function () {
    // 開演日時を設定（例：2025年12月10日 18:00）
    const targetDate = new Date("2025-12-10T18:00:00+09:00");
    ...
    function updateCountdown() {
        ...
        if (diff <= 0) {
            document.querySelector('.countdown').innerHTML = "<h2>開演しました！</h2>";
            return;
        }
        ...
        document.querySelector('.days-1 .top').textContent = Math.floor(days / 10);
        document.querySelector('.days-2 .top').textContent = days % 10;
        document.querySelector('.hours-1 .top').textContent = Math.floor(hours / 10);
        document.querySelector('.hours-2 .top').textContent = hours % 10;
        document.querySelector('.min-1 .top').textContent = Math.floor(minutes / 10);
        document.querySelector('.min-2 .top').textContent = minutes % 10;
        document.querySelector('.sec-1 .top').textContent = Math.floor(seconds / 10);
        document.querySelector('.sec-2 .top').textContent = seconds % 10;
    }
